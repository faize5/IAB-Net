...
model_urls = {
    ...
    #'resnet101': 'https://www.dropbox.com/s/wtvciofya1k1dpz/eca_resnet101_k3357.pth.tar?dl=1',
...
def resnet50_backbone():
    ...
    init_pretrained_weights(network, model_urls['resnet101'])
...
def resnet50(num_classes, args, pretrained=False, k_size=[3, 3, 3, 3], **kw):
    ...
    print("Constructing ECA_Resnet101 ......")
