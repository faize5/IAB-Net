...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, use_coab=False):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, att_type=None):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, use_coab=att_type=='COAB'))
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers.append(block(self.inplanes, planes, use_coab=att_type=='COAB'))
